                            ...
                            @foreach($products as $product)
                                <div class="single-product">
                                    <div class="product-f-image">
                                        <img src="{{ asset($product->image) }}" alt="" style="height: 270px; width: 200px;">
                                        <div class="product-hover">
                                            <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                            <a href="{{ route('detail.product',['id' => $product->id]) }}" class="view-details-link"><i class="fa fa-link"></i>
                                                See details</a>
                                        </div>
                                    </div>
                                    <h2><a href="">{{ $product->name }}</a></h2>
                                    <div class="product-carousel-price">
                                        <ins>{{ $product->product_price }} TK</ins>
                                    </div>
                                </div>
                            @endforeach
                        </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <div class="single-wid-product">
                            <a href="single-product.html"><img src="{{ asset('frontEndAsset') }}/img/product-thumb-1.jpg"
                        ...
                        <div class="single-wid-product">
                            <a href="single-product.html"><img src="{{ asset('frontEndAsset') }}/img/product-thumb-2.jpg"
                                                               alt="" class="product-thumb"></a>
                        ...
                        <div class="single-wid-product">
                            <a href="single-product.html"><img src="{{ asset('frontEndAsset') }}/img/product-thumb-3.jpg"
                                                               alt="" class="product-thumb"></a>
                ...
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <a href="#" class="wid-view-more">View All</a>
                        <div class="single-wid-product">
                            <a href="single-product.html"><img src="{{ asset('frontEndAsset') }}/img/product-thumb-4.jpg"
                                                               alt="" class="product-thumb"></a>
